...
(function () {
    ...
    var T = {
        ...
        it: {
            ...
            'review.1.text':        '"Abbiamo recentemente provato alcune pizze in zona ed erano tra le migliori che avessimo mai mangiato. Il servizio era eccellente, i prezzi ragionevoli e il cibo delizioso."',
        ...
        de: {
            ...
            'review.1.text':        '"Wir haben kürzlich einige Pizzen in der Gegend probiert, und es war eine der besten, die wir je hatten. Der Service war ausgezeichnet, die Preise angemessen und das Essen köstlich."',
        ...
        fr: {
            ...
            'review.1.text':        '"Nous avons récemment essayé quelques pizzas dans le coin et c\'était l\'une des meilleures que nous ayons mangées. Le service était excellent, les prix raisonnables et la nourriture délicieuse."',
